                        ...
                        <div class="row d-flex justify-content-center align-items-center">
                            ...
                            <div class="col-md-3 col-lg-3 col-xl-2 d-flex">
                                <form action="{{route('cart.update', $cartItem->id)}}" method="POST">
                                    ...
                                    <div class="col-md-3 col-lg-2 col-xl-2 offset-lg-1">
                                        <h5 class="mb-0 text text-center text-md-start product-price">{{$cartItem->product->price * $cartItem->quantity}} €</h5>
                                </form>
                            </div>
...
document.querySelectorAll("input[type=number]").forEach((input) => {
  input.addEventListener("change", (e) => {
    ...
    postData("/cart/" + productId, { quantity: quantityVal }).then((data) => {
      // update the price of the product
      // fix floating point number
      data.price = data.price.toFixed(2);
      e.target.parentNode.parentNode.parentNode.querySelector(".product-price").innerHTML = data.price + " €";
