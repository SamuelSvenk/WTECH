...
<div class="container px-4 px-lg-5 my-5">
    <div class="row gx-4 gx-lg-5 align-items-center">
        <div class="col-md-6">
            <!-- <img class="card-img mb-4 mb-md-0 rounded-5" src="{{ asset('storage/' . $product->image) }}" alt="..." > -->
            <div id="carouselIndicators" class="carousel slide bg-secondary rounded mx-auto " data-bs-ride="carousel" >
                <div class="carousel-inner rounded" style="background-color: #ABABAB"> 
                    @foreach ($product->images as $image)
                        <div class="carousel-item active">
                            <img src="{{ asset('storage/' . Str::after($image->image_path, 'public/')) }}" class="d-block center w-100 img mb-4 mb-md-0" alt="...">
                        </div>
                    @endforeach
                </div>
